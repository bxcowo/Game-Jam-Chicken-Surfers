...
from game.utils.resources import get_obstacle_sprite


class Obstacle(pygame.sprite.Sprite):
    def __init__(self, gx: int, gy: int, height_band: HeightBand, speed: float) -> None:
        ...
        self.image = get_obstacle_sprite(height_band)
